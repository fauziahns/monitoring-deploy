...
export default function Tabel({data}) {
  return (
    <div className="h-full bg-[#182331]">
      ...
      {data.map((item => (
        <div className="flex bg-[#1F2A37] w-full lg:w-[1132px] md:w-[1132px] xl:w-[1132px] 2xl:w-[1132px] mx-auto text-white px-5 h-[50px] items-center text-[14px] font-[600] border-[#374151] border-b-[1px]">
